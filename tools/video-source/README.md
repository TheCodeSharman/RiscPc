...
| `make_acorn_mdf.py` | **Host side.** Generates `RetroScaler-Acorn.mdf`, the union of the thirteen stock Acorn definitions, 15.6 to 63.7 kHz, timings copied verbatim, AKF50 winning any tie. |
